                                                    ...
                                                    <div className="inner-box">
                                                        ...
                                                        <div className="box_content" id="product_price">
                                                            ...
                                                            <div className="row footer">
                                                                ...
                                                                <div className="col-2">
                                                                    <a href={"https://wa.me/+918375924100?text=I am interested in property " + x.code + " => " + getWATemplateOfProperty(x, prop)} className="see_details" target="_blank"><i className="icon fa fa-whatsapp fa-white"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
